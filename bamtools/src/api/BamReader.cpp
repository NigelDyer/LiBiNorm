...
// ***************************************************************************
// Modified for LiBiNorm to provide faster BAM file read mode
...
*/
bool BamReader::GetNextAlignment(BamAlignment& alignment,bool buildAlignBases) {
    return d->GetNextAlignment(alignment,buildAlignBases);
}
